...
class EducationModel(EconModelClass):
    ...
    def allocate(self):
        ...
        # m. solution arrays 
        shape = (par.T,par.Nfix,par.Nst,par.Ne)
                ...
                for i_st, school_time in enumerate(par.school_time_grid):
                    for i_e, experience in enumerate(par.experience_grid):
                        ...
                        if t == par.T-1:
                            ...
                            utility_school = self.utility_school(school_time, util_school_fix, nuxi)
                            ...
                            # a. bellman school
                            bellman_school = self.bellman_school(t,school_time, i_fix, nuxi)
    ...
    def bellman_school(self,t, school_time, i_fix, nuxi):
